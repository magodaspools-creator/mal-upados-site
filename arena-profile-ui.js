...
(()=>{
  ...
  function installStyle(){
    ...
    const style=document.createElement('style');style.id=STYLE_ID;style.textContent=`
      ...
      .arena-equipment-stage{position:relative;width:100%;max-width:100%;box-sizing:border-box;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));grid-template-rows:repeat(3,84px);gap:8px;align-items:center;justify-items:center;min-height:272px;padding:3px}
      .arena-equipment-slot{width:74px;max-width:100%;height:76px;box-sizing:border-box;padding:2px 3px;text-align:center;position:relative;overflow:visible;background:transparent;border:0;box-shadow:none}
      .arena-equipment-slot.is-empty{opacity:1}.arena-item-icon{width:52px;height:52px;margin:0 auto;display:grid;place-items:center}
      .arena-item-sprite{width:48px;height:48px;image-rendering:pixelated;filter:none}.arena-empty-sprite{width:48px;height:48px;filter:none!important;opacity:1}
      .arena-equipment-slot small,.arena-equipment-slot strong,.arena-equipment-slot em{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
      .arena-equipment-slot small{font-size:.4rem;color:#858a92;text-transform:uppercase;letter-spacing:.45px}.arena-equipment-slot strong{font-size:.47rem;color:#d5d7db;margin-top:2px}.arena-equipment-slot em{font-size:.39rem;color:var(--gold2);font-style:normal;margin-top:2px}
      .slot-amulet{grid-column:1;grid-row:1}.slot-helmets{grid-column:2;grid-row:1}.slot-backpack{grid-column:3;grid-row:1}.slot-weapon{grid-column:1;grid-row:2}.slot-armor{grid-column:2;grid-row:2}.slot-shield{grid-column:3;grid-row:2}.slot-rings{grid-column:1;grid-row:3}.slot-boots{grid-column:2;grid-row:3}.slot-ammo{grid-column:3;grid-row:3}
      .arena-character-core,.arena-character-glow,.arena-character-avatar,.arena-character-core small{display:none!important}
      @media(max-width:620px){.arena-set-grid{padding:14px 6px}.arena-equipment-stage{grid-template-rows:repeat(3,78px);gap:8px;min-height:256px;padding:2px}.arena-equipment-slot{width:70px;height:72px}.arena-item-icon{width:48px;height:48px}.arena-item-sprite{width:44px;height:44px}.arena-empty-sprite{width:44px;height:44px;filter:none!important;opacity:1}}
