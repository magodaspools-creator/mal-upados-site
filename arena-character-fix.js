...
(()=>{
  // These two modules are already loaded directly by arena.html.
  // Loading them again here created two independent fronts/initializers.
  const files=[
    'arena-campaign-timer-fix.js?v=timer-fix-20260912c','arena-bestiary-fix.js?v=bestiary-infinite-20260912a','arena-bestiary-counter-fix.js?v=bestiary-counter-infinite-20260912a','arena-bestiary-platinum-popup.js?v=platinum-popup-20260912a','arena-combat-final-fix.js?v=combat-fix-20260912','arena-flee-fix.js?v=flee-fix-20260912','arena-gold-universal.js?v=gold-universal-20260912','arena-account-systems.js?v=account-systems-20260912a','arena-profile-advanced.js?v=profile-advanced-20260912b','arena-achievements-v2.js?v=achievements-v2-20260912a','arena-ranking-v2.js?v=ranking-v2-20260912c'
  ];
