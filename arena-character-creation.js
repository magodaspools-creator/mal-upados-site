(()=>{
  ...
  function style(){
    ...
    s.textContent=`
      .arena-char-gate{position:fixed;inset:0;z-index:100050;background:rgba(4,6,10,.9);backdrop-filter:blur(9px);display:flex;align-items:center;justify-content:center;padding:20px}
      .arena-char-window{width:min(760px,100%);max-height:92vh;overflow:auto;background:linear-gradient(145deg,#17191e,#0c0e12);border:1px solid rgba(180,139,60,.55);border-radius:12px;box-shadow:0 30px 100px rgba(0,0,0,.7);padding:28px;color:#fff}
      .arena-char-window h2{font:900 27px Cinzel,serif;color:#e8c66f;margin:0 0 7px}.arena-char-window .intro{color:#9da3ac;font-size:14px;line-height:1.5;margin:0 0 20px}
      .arena-char-field{margin-top:16px}.arena-char-field label{display:block;color:#cdd1d6;font:800 12px Inter,sans-serif;margin-bottom:7px;text-transform:uppercase;letter-spacing:.7px}
      .arena-char-input{width:100%;box-sizing:border-box;background:#080b10;border:1px solid #383d44;color:#fff;border-radius:8px;padding:13px;font:600 14px Inter,sans-serif;outline:none}.arena-char-input:focus{border-color:#c69b46}
      .arena-char-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.arena-char-choice{appearance:none;text-align:left;border:1px solid #343941;background:#121519;color:#d7dbe0;border-radius:9px;padding:14px;cursor:pointer;transition:.15s}.arena-char-choice:hover{border-color:#80632f;background:#191714}.arena-char-choice.selected{border-color:#c49a4b;background:linear-gradient(145deg,#241e14,#15171b);box-shadow:inset 0 0 0 1px rgba(196,154,75,.18)}
      .arena-char-choice .choice-title{font:900 14px Inter,sans-serif}.arena-char-choice .choice-desc{display:block;color:#8e959e;font-size:12px;line-height:1.4;margin-top:5px}.arena-char-choice .choice-icon{font-size:23px;float:right;margin-left:8px}
      .arena-vocation-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px}.arena-vocation{min-height:125px}.arena-vocation .choice-icon{float:none;display:block;margin:0 0 8px;font-size:27px}.arena-vocation .choice-title{display:block}.arena-vocation .choice-desc{font-size:11px}
      .arena-char-preview{display:flex;align-items:center;gap:14px;padding:13px;border:1px solid #2e3339;background:#111418;border-radius:9px;margin-top:16px}.arena-char-preview-avatar{width:58px;height:58px;display:grid;place-items:center;border-radius:50%;background:#1c2026;border:1px solid #4b5159;font-size:31px}.arena-char-preview strong{display:block;color:#e4e7eb}.arena-char-preview span{display:block;color:#8b929b;font-size:12px;margin-top:3px}
      .arena-char-actions{display:flex;justify-content:flex-end;gap:9px;margin-top:20px}.arena-char-btn{border:1px solid #4b4f56;background:#171a1e;color:#d8dbe0;border-radius:7px;padding:11px 16px;font:900 12px Inter,sans-serif;cursor:pointer}.arena-char-btn.primary{background:linear-gradient(180deg,#b98d3d,#765622);border-color:#d1ab62;color:#fff}.arena-char-btn:disabled{opacity:.45;cursor:not-allowed}.arena-char-msg{min-height:20px;margin-top:10px;color:#c9a55e;font-size:12px}.arena-char-msg.error{color:#e58d83}
      .arena-char-create-small{display:inline-flex;align-items:center;gap:7px;margin:10px 0 0;padding:9px 12px;border:1px solid #7d6332;background:#1c1811;color:#e5c675;border-radius:7px;font:900 11px Inter,sans-serif;cursor:pointer}
      @media(max-width:720px){.arena-vocation-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.arena-char-grid{grid-template-columns:1fr}.arena-char-window{padding:20px}}
