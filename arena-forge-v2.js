(()=>{
  ...
  // Endgame Forge: unlocked by Demon, fueled by a dedicated no-XP dungeon.
  // Tier bonuses are intentionally stronger than the previous version so a
  // full T5 set is a real alternative path toward Deathbringer.
  const TIERS=[
    {tier:1,cost:20000,cores:2,chance:.85,attack:10,hp:25,defense:2,lifesteal:1},
    {tier:2,cost:45000,cores:4,chance:.70,attack:16,hp:40,defense:3,lifesteal:1},
    {tier:3,cost:90000,cores:7,chance:.55,attack:24,hp:65,defense:5,lifesteal:2},
  ...
  const DUNGEON=[
    ...
    {name:'Abominação da Forja',icon:'👹',hp:1750,damage:185,gold:[3000,4300],drop:'Metal Infernal',dropChance:.28,cores:2},
