...
(()=>{
  ...
  function sprite(it){
    if(it?.sprite)return `<img src="${window.arenaItemSpriteUrl?window.arenaItemSpriteUrl(it):'arena-godot/assets-importados/'+encodeURI(it.sprite)}" alt="${esc(it.name)}" draggable="false" style="width:44px;height:44px;image-rendering:pixelated;object-fit:contain">`;
